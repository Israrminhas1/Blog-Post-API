...
use DI\Container;
use ProjectApi\Repository\CategoryRepositoryFromDoctrine;
use ProjectApi\Repository\PostRepositoryFromDoctrine;
...
$container->set('category-repository', static function (Container $c){
    ...
    return new CategoryRepositoryFromDoctrine($em);
});
$container->set('post-repository', static function (Container $c){
    $em = $c->get(EntityManager::class);
    return new PostRepositoryFromDoctrine($em);
});
